Ovdje se nalaze rezultati k6 load testova za API: https://petstore.swagger.io/

Skripte za testiranje (smoke, stress, spike, full load) i generisani izvještaji se nalaze u ovom direktoriju.
